...
class GetSubscriptionPlanServices {
  static Future<GetSubscriptionPlanModel?> getSubscriptionPlan(
      String url, Object body) async {
    GetSubscriptionPlanModel? result;
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        result = GetSubscriptionPlanModel.fromJson(item);
      } else {
